              ...
              <Form role="form">
                <FormGroup>
                  <InputGroup className="input-group-alternative mb-3">
                    ...
                    <Input placeholder="User Name" type="text" onChange={e => this.onChange("username", e.target.value)}/>
                  </InputGroup>
                </FormGroup>
                <FormGroup>
                  <InputGroup className="input-group-alternative mb-3">
                    ...
                    <Input placeholder="First Name" type="text" onChange={e => this.onChange("firstname", e.target.value)}/>
                  </InputGroup>
                </FormGroup>
                <FormGroup>
                  <InputGroup className="input-group-alternative mb-3">
                    ...
                    <Input placeholder="Last Name" type="text" onChange={e => this.onChange("lastname", e.target.value)}/>
                  </InputGroup>
                </FormGroup>
                <FormGroup>
                  <InputGroup className="input-group-alternative mb-3">
